...
$resultado = mysql_query('SELECT titulo FROM catalogo;');
for($i=0;$i<mysql_num_rows($resultado);$i++){
?>
<section id="center">
<div class="bmw">
<img src="<?php
    $resultado = mysql_query('SELECT img FROM catalogo;');
    echo mysql_result($resultado,$i);
?>" alt="BMW 4 Series Comvertible">
<hgroup>
<h1><strong><?php
    $resultado = mysql_query('SELECT titulo FROM catalogo;');
    echo mysql_result($resultado,$i);
?></strong></h1>
<p><?php
    $resultado = mysql_query('SELECT descrpcion FROM catalogo;');
    echo mysql_result($resultado,$i);
?></p>
</hgroup>
